...
import com.fefuproject.druzhbank.dirprofile.dirfragmentprofile.dirhistoryopenapp.HistoryOpenApp
import com.fefuproject.druzhbank.dirprofile.dirfragmentprofile.dirhistoryopenapp.HistoryOpenAppAdapter
...
class HistoryOpenApplicationFragment : Fragment() {
    ...
    private val h = HistoryOpenApp(
        date = "06.01.2022",
        time = "15:59"
    )
    private val h1 = HistoryOpenApp(
        date = "16.01.2022",
        time = "13:59"
    )
    ...
    override fun onCreateView(
        ...
        adapter.addHistoryOpenApp(h)
        adapter.addHistoryOpenApp(h1)
        adapter.addHistoryOpenApp(h)
        adapter.addHistoryOpenApp(h1)
        adapter.addHistoryOpenApp(h)
        adapter.addHistoryOpenApp(h1)
